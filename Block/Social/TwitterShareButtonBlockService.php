...
class TwitterShareButtonBlockService extends BaseShareButtonBlockService
{
    /**
     * {@inheritdoc}
     */
    public function execute(BlockContextInterface $blockContext, Response $response = null)
    {
        ...
        if($url && $title) {
            $settings['share_url'] = sprintf('https://twitter.com/home?status=%s+%s', urlencode($title), urlencode($url));
        }
    ...
    public function setDefaultSettings(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'template'    => 'RzSeoBundle:Block:block_twitter_share_button.html.twig',
            'url'         => null,
            'title'       => null,
            'default_url' => null,
            'default_title'=> null,
    ...
    {
        return 'Rz Custom Twitter Share button';
    }
}
