...
class PinterestShareButtonBlockService extends BaseShareButtonBlockService
{
    ...
    public function execute(BlockContextInterface $blockContext, Response $response = null)
    {
        ...
        if($url && $title) {
            $settings['share_url'] = sprintf('http://pinterest.com/pin/create/bookmarklet/?media=%s&url=%%&is_video=false&description=%s', urlencode($mediaUrl), urlencode($url), $settings['is_video'], urlencode($title));
        }
